...
namespace InterfazEstilos.Pages
{
    /// <summary>
    ...
    public sealed partial class HomePage : Page
    {
        ...
        private void btnIluminacion_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(Habitaciones));
        }

        private void btnCamara_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(Camaras));
        }

        private void btnAlarma_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(IntroducirCodigo));
        }
